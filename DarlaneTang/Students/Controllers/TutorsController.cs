...
namespace Students.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(StudentsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TutorId,TFname,TLname,TPhone")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TutorId,TFname,TLname,TPhone")] Tutor tutor)
        {
            if (id != tutor.TutorId)
            {
                return NotFound();
