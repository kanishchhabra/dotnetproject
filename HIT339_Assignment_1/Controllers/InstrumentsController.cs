...
namespace HIT339_Assignment_1.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public InstrumentsController(HIT339_Assignment_1Context context)
        {
            _context = context;
        }
        ...
        {
            ViewData["InstrumentType"] = new SelectList(Enum.GetValues(typeof(InstrumentType)));
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("id,InstrumentName")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,InstrumentName")] Instrument instrument)
        {
            if (id != instrument.id)
            {
                return NotFound();
