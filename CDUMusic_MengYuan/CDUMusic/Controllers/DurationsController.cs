...
namespace CDUMusic.Controllers
{
    public class DurationsController : Controller
    {
        ...
        public DurationsController(CDUMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DurationId,Time,Cost")] Duration duration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DurationId,Time,Cost")] Duration duration)
        {
