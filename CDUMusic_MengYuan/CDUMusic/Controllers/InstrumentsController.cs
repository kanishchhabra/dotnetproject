...
namespace CDUMusic.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public InstrumentsController(CDUMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("InstrumentId,InstrumentName,InsType")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstrumentId,InstrumentName,InsType")] Instrument instrument)
        {
